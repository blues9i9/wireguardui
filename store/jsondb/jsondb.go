...
func (o *JsonDB) Init() error {
	...
	if _, err := os.Stat(globalSettingPath); os.IsNotExist(err) {
		...
		globalSetting.SmtpHostname = util.LookupEnvOrString("SMTP_HOSTNAME", "")
		globalSetting.SmtpPort = util.LookupEnvOrInt("SMTP_PORT", 25)
		globalSetting.SmtpUsername = util.LookupEnvOrString("SMTP_USERNAME", "")
		globalSetting.SmtpPassword = util.LookupEnvOrString("SMTP_PASSWORD", "")
		globalSetting.SmtpAuthType = util.LookupEnvOrString("SMTP_AUTH_TYPE", "NONE")
		globalSetting.SmtpEncryption = util.LookupEnvOrString("SMTP_ENCRYPTION", "STARTTLS")
		globalSetting.SmtpNoTLSCheck = false
		globalSetting.EmailFrom = util.LookupEnvOrString("EMAIL_FROM_ADDRESS", "")
		globalSetting.EmailFromName = util.LookupEnvOrString("EMAIL_FROM_NAME", "WireGuard UI")
		globalSetting.EnableAutoEmail = false
